...
class PersonalScheduleDAL:
    ...
    async def delete_all_personal_schedule(self, id: int, stream_group: str, day: str, parity: str):
        await self.db_session.execute(delete(PersonalSchedule).where(PersonalSchedule.id == id,
                                                                     PersonalSchedule.stream_group == stream_group,
                                                                     PersonalSchedule.day == day,
                                                                     PersonalSchedule.parity == parity))
